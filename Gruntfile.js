module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        uglify: {
            ...
            amd: {
                src: 'dist/davinci-units.js',
                dest: 'dist/davinci-units.min.js'
            },
            system: {
                src: 'dist/davinci-units-system-es5.js',
                dest: 'dist/davinci-units-system-es5.min.js'
            }
        },
        ...
        tslint: {
            src: [
                "src/davinci-units/davinci-units.ts",
                "src/davinci-units/checks/**/*.ts",
                "src/davinci-units/collections/**/*.ts",
                "src/davinci-units/commands/**/*.ts",
                "src/davinci-units/controls/**/*.ts",
                "src/davinci-units/core/**/*.ts",
                "src/davinci-units/facets/**/*.ts",
                "src/davinci-units/geometries/**/*.ts",
                "src/davinci-units/materials/**/*.ts",
                "src/davinci-units/math/**/*.ts",
                "src/davinci-units/overlay/**/*.ts",
                "src/davinci-units/visual/**/*.ts",

                "src/davinci-units/utils/EventEmitter.ts",
                "src/davinci-units/utils/exists.ts"
            ],
            options: {
        ...
        typedoc: {
            build: {
                options: {
                    ...
                    out: 'documentation/',
                    mode: 'file',
                    name: 'UNITS <%= pkg.version %>',
                    exclude: [
                        'src/davinci-units/core/ErrorMode.ts',
                        'src/davinci-units/shapes/ArrowBuilder.ts',
                        '**/*.spec.ts'
                    ],
                    excludeExternals: false,
                    hideGenerator: true
                },
                src: 'src/davinci-units/**/*.ts'
            }
        },
        complexity: {
            generic: {
    ...
    function bundle() {
        ...
        return builder.bundle('davinci-units.js', 'dist/davinci-units-system-es5.js', options);
    }
